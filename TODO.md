...
- [ ] **T005 · refactor · p1: update UserCardStatsStore to use standardized errors**
    - **Context:** cr‑01 Centralize and standardize entity-specific error contracts
    - **Action:**
...
- [ ] **T007 · refactor · p1: refactor MemoStore to use error mapping helpers**
    - **Context:** cr‑03 Consistent error mapping with helpers
    - **Action:**
...
- [ ] **T008 · refactor · p1: refactor CardStore to use error mapping helpers**
    - **Context:** cr‑03 Consistent error mapping with helpers
    - **Action:**
